...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(now|today|tonight|tomorrow|tmr|tom|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e,s){var t=e[0].substr(e[1].length),a=e.index+e[1].length,i=new ParsedResult({index:a,text:t,ref:r}),n=moment(r),o=n.clone(),m=t.toLowerCase(),l=["tomorrow","tmr","tom"];if("tonight"==m)i.start.imply("hour",22),i.start.imply("meridiem",1);else if(l.indexOf(m)>-1)n.hour()>1&&o.add(1,"day");else if("yesterday"==m)o.add(-1,"day");else if(m.match(/last\s*night/))i.start.imply("hour",0),n.hour()>6&&o.add(-1,"day");else if(m.match("this")){var u=e[3].toLowerCase();"afternoon"==u?i.start.imply("hour",15):"evening"==u?i.start.imply("hour",18):"morning"==u&&i.start.imply("hour",6)}else m.match("now")&&(i.start.imply("hour",n.hour()),i.start.imply("minute",n.minute()),i.start.imply("second",n.second()),i.start.imply("millisecond",n.millisecond()));return i.start.assign("day",o.date()),i.start.assign("month",o.month()+1),i.start.assign("year",o.year()),i.tags.ENCasualDateParser=!0,i}};
},{"../../result":34,"../parser":25,"moment":1}],5:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(within|in)\s*([0-9]+|an?|half(?:\s*an?)?)\s*(minutes?|hours?|days?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,a,r,e){var s=r.index+r[1].length,t=r[0];t=r[0].substr(r[1].length,r[0].length-r[1].length);var n=new ParsedResult({index:s,text:t,ref:a}),i=r[3];i="a"===i||"an"===i?1:i.match(/half/)?.5:parseInt(i);var m=moment(a);return r[4].match(/day/)?(m.add(i,"d"),n.start.assign("year",m.year()),n.start.assign("month",m.month()+1),n.start.assign("day",m.date()),n):(r[4].match(/hour/)?m.add(i,"hour"):r[4].match(/minute/)&&m.add(i,"minute"),n.start.imply("year",m.year()),n.start.imply("month",m.month()+1),n.start.imply("day",m.date()),n.start.assign("hour",m.hour()),n.start.assign("minute",m.minute()),n.tags.ENDeadlineFormatParser=!0,n)}};
